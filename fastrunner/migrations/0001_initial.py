# Generated by Django 2.1.3 on 2019-11-03 22:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leveltag_name', models.CharField(max_length=100, verbose_name='层级名称')),
            ],
            options={
                'verbose_name': '用例信息',
                'db_table': 'Case',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('step', models.IntegerField(verbose_name='执行顺序')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(default='', verbose_name='层级名称')),
                ('level', models.IntegerField(default=1, verbose_name='当前层级')),
                ('parentName', models.TextField(default='', verbose_name='父级名称')),
                ('ltype', models.IntegerField(default=1, verbose_name='主体类型')),
            ],
            options={
                'verbose_name': '层级标签关系',
                'db_table': 'LevelTag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('length', models.IntegerField(verbose_name='用例个数')),
                ('leveltag_name', models.CharField(max_length=100, verbose_name='层级名称')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fastrunner.Project')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='casestepinsuite',
            name='suite',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fastrunner.Suite'),
        ),
        migrations.AddField(
            model_name='case',
            name='project',
